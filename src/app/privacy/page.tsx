...
export const metadata: Metadata = {
  title: 'Политика конфиденциальности | Архитектура Счастья',
  description: 'Политика конфиденциальности программы трансформации Архитектура Счастья',
  robots: {
    index: true,
    follow: true,
  },
        ...
        <div className="prose prose-lg max-w-none space-y-8 text-text-secondary">
          ...
          <section>
            ...
            <p>
              ...
              «Архитектура Счастья» (далее — Сайт).
            </p>
            <p>
